...
test("semantic kernel is consumed as an external peer dependency", () => {
  ...
  assert.equal(fs.existsSync("capabilities/executes-relational-query/projectors/typescript/json-schema-types.projection.v1.json"), true);
  assert.match(
    fs.readFileSync("capabilities/executes-relational-query/4-adapters/typescript/relational-query.contract.ts", "utf8"),
